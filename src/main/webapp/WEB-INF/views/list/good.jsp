...
<div class="col">
    ...
    <div class="col-6">
    <div class="d-flex w-100 justify-content-between">
      <h5 class="mb-1 mr-5 " style="width:600px;">${g.content }</h5>
    </div>
    </div>
    <div class="col">
    	<div class="row-col">
     ...
     <div class="col pt-5">
     	<div class="d-flex w-100 justify-content-between">
    			<c:if test="${g.rate < 2.0}" > 
						<div class="customer-rating customer-rating-red">${g.rate }</div>
					</c:if>
					<c:if test="${g.rate eq 3.0 }">
						<div class="customer-rating customer-rating-yellow">${g.rate }</div>
					</c:if>
					<c:if test="${g.rate eq 4.0 }">
						<div class="customer-rating customer-rating-">${g.rate }</div>
					</c:if>
					<c:if test="${g.rate eq 5.0 }">
						<div class="customer-rating customer-rating-green">${g.rate }</div>
					</c:if>
				</div>
    	</div>
    </div>
