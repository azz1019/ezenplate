...
<main id="main">
						...
						<div class="container-main single-main">
							<div class="col-md-12">
								<div class="block-main mb-3">
									<div class="journal-txt mb-2">

										<div class="container mt-4">
											<div class="row">
										<c:if test="${ses.nickName == bdto.bvo.writer}">
												<a href="/board/modify?">수정</a>
												<button type="button" class="" id="boardRemove">삭제</button>
										</c:if>
											</div>
									...
									<div class="post-meta">
										<ul class="list-unstyled">
											...
											<li class="commont"><i class="ion-ios-heart-outline"></i>댓글 <span
												class="commentQty">${bdto.bvo.cmtQty }</span></li>
											<li class="commont"><i class="ion-ios-heart-outline"></i>공감 <span
												class="commentQty">${bdto.bvo.cmtQty }</span></li>
									...
									<div class="content-main single-post padDiv">
										<p class="mb-3">${bdto.bvo.content }</p>
									</div>
								</div>
							</div>
							<div class="col-md-12">
    ...
    <p>예시</p>
										...
										<h6 class="mb-3"><span class="commentQty">${bdto.bvo.cmtQty } </span> Comments</h6>
											<div class="commentForm" >
												<div class="entry-comments-body">
													<span class="entry-comments-author">TESTER</span>
													<span><a href="#">2022.08.11. 14시 35분</a></span>
													<p class="mb-10">저도 너무 가고싶어요ㅠㅠㅠ!</p>
												</div>
													<div class="entry-comments-body">
													<span class="entry-comments-author">USER1</span>
													<span><a href="#">2022.08.11. 14시 42분</a></span>
													<p class="mb-10">독일 가는건가요~?</p>
												</div>
													<div class="entry-comments-body">
													<span class="entry-comments-author">ADMIN</span>
													<span><a href="#">2022.08.11. 14시 45분</a></span>
													<p class="mb-10">갑시다!!!!!!!!</p>
												</div>
											</div>
										</div>
